        ...
        <div className="flex items-start sm:items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-base font-bold text-white">Progressive Web App (PWA)</h3>
              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">
                100% Offline Gym Mode
              </span>
            </div>
            <p className="text-xs text-gray-400 mt-1 max-w-xl">
              FITRACK works seamlessly in gym basements with zero internet. Workouts, exercises, timers, and Indian diets are cached locally. Install directly to your home screen for fullscreen mobile app experience.
            </p>
          </div>
        </div>

        <div className="shrink-0 flex items-center gap-2">
          <div className="px-3.5 py-2 rounded-xl bg-gray-800/80 border border-gray-700/60 text-xs text-gray-300 flex items-center gap-2">
            <Wifi className="w-3.5 h-3.5 text-emerald-400" />
            <span className="text-[11px] font-medium">Service Worker Active</span>
          </div>
        </div>
      </div>
